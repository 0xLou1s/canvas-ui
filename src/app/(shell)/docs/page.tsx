...
Every component ships in four flavors: React, Vue, Svelte, and vanilla TypeScript. Each one is a single standalone file, built on the same engine with the same options. Pick your framework once in the docs and every install command and code example follows.
  ...
  return (
    <article className="page-enter mx-auto w-full max-w-3xl">
      <div className="typeset typeset-docs">
        ...
        <p>
          Every component ships in four flavors: React, Vue, Svelte, and vanilla
          TypeScript. Each one is a single standalone file, built on the same
          engine with the same options. Pick your framework once in the docs and
          every install command and code example follows.
        </p>
